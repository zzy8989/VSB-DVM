...
parser.add_argument('--lr', type=float, default=0.0005, metavar='N',
                    help='learning rate.')
parser.add_argument('--gmmlr', type=float, default=1.3, metavar='N',
...
torch.manual_seed(642235) #0.7953 100 0.0005 1.3  lr = max(args.lr * 0.8**(np.floor(epoch/5.0)), 0.0001)
...
class VAE(nn.Module):
    def __init__(self, lr = 0.002, gmm_lr = 1, n_gmm = 4, latent_dim=30):
